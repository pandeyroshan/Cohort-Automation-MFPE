...
<html lang="en">
  ...
  <body>
    ...
    <div class="main p-5">
      <h1 class="font-weight-light text-center mt-5">Reset your password</h1>
      <div class="p-5 mt-3" style="background-color: #C4C4C4;">
        <form method="post">
            ...
            <input type="password" class="form-control" name="password" placeholder="Set a new password">
            
            <label for="exampleInputEmail1" style="font-size: 15px;">Confirm New Password</label>
