...
<html lang="en">
    <head>
        ...
        <title>Admin Dashboard - All Trainer</title>
        <style>
            body {
    ...
    <body>
        <div class="sidenav">
            ...
            <div class="text-left pl-5 pt-3 pr-5">
                ...
                <p class="myNavLink" ><strong>Trainer</strong></p>
                <hr>
        ...
        <div class="main px-4">
            ...
            <div class="text-right mr-3">
                <a href="/create-trainer"><button class="btn btn-success btn-sm">Create Trainer</button></a>
            </div>
						  ...
						  <div class="modal-dialog" role="document">
						    <div class="modal-content">
						      <div class="modal-header">
						        <h5 class="modal-title" id="exampleModalLongTitle">${user.getFullName()} - Coach</h5>
