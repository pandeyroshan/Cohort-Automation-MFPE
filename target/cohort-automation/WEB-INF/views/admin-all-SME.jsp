<%@ page import="com.cohortautomation.beans.User, java.util.*" language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
...
<html lang="en">
    <head>
        ...
        <title>Admin Dashboard - All SME</title>
        <style>
            body {
    ...
    <body>
        <div class="sidenav">
            ...
            <div class="text-left pl-5 pt-3 pr-5">
                ...
                <p class="myNavLink" ><strong>SMEs</strong></p>
        ...
        <div class="main px-4">
            ...
            <div class="text-right mr-3">
                <a href="/create-sme"><button class="btn btn-success btn-sm">Create SME</button></a>
            </div>
						  ...
						  <div class="modal-dialog" role="document">
						    <div class="modal-content">
						      <div class="modal-header">
						        <h5 class="modal-title" id="exampleModalLongTitle">${user.getFullName()} - SME</h5>
