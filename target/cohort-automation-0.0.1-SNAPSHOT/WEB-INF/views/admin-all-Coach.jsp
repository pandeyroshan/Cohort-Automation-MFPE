...
<html lang="en">
    <head>
        ...
        <title>Admin Dashboard - All Coach</title>
        <style>
            body {
    ...
    <body>
        <div class="sidenav">
            ...
            <div class="text-left pl-5 pt-3 pr-5">
                ...
                <p class="myNavLink" ><strong>Coaches</strong></p>
        ...
        <div class="main px-4">
            ...
            <div class="text-right mr-3">
                <a href="/create-coach"><button class="btn btn-success btn-sm">Create Coach</button></a>
            </div>
