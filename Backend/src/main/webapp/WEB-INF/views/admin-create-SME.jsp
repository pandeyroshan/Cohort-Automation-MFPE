...
<html lang="en">
  <head>
    ...
    <title>Admin Dashboard - Create SME</title>
    <style>
      body {
  ...
  <body>
    <div class="sidenav">
      ...
      <div class="text-left pl-5 pt-3 pr-5">
        ...
        <p class="myNavLink" onclick="location.href='/all-sme'"><strong>SMEs</strong></p>
