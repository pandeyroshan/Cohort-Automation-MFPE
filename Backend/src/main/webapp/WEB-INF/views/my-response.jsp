	  ...
	  <div class="p-5 mt-3" style="background-color: #C4C4C4;">
        <form action="/submit-survey" method="post">
        	...
        	<%
        		...
        		HashMap<String, String> surveyResponse = (HashMap) request.getAttribute("response");
        		
        		for(Map.Entry<String,String> entry : surveyResponse.entrySet()){
        			out.print("<label style=\"font-size: 15px;\">"+entry.getKey()+"</label>");
        			
        			out.print("<input type=\"text\" class=\"form-control\" value="+ entry.getValue() + " placeholder=\"Answer here\" readonly>");
        		}
        	%>
